...
extern void TIMER01_0_enter_DefaultMode_from_RESET(void) {
	...
	TH0 = 00111000;
	TL0 = 10011110;
	//Setting timer low byte and high byte in order for timer 0 to overflow at 14494 which is 10hz  which is 100ms,
	//once this interrupt occurs we want the flag to be flagged and then update the screen
	TCON_TR0=1;

}
extern void TIMER_SETUP_0_enter_DefaultMode_from_RESET(void) {
	// $[CKCON0 - Clock Control 0]
	CKCON0 = 0x2  | 0 | CKCON0_T2MH__EXTERNAL_CLOCK | CKCON0_T2ML__EXTERNAL_CLOCK
			| CKCON0_T3MH__EXTERNAL_CLOCK | CKCON0_T3ML__EXTERNAL_CLOCK
			| CKCON0_T1M__SYSCLK;
// here we are setting Timer 2 to use a prescaled sysclock. It is scaled down by 48
//	effectivly making it run at .510416 MHz JP

//Enabiling timer 0 interrupt JP
	TMOD = 0x1 | TMOD_T1M__MODE2 | TMOD_CT0__TIMER
			| TMOD_GATE0__DISABLED | TMOD_CT1__TIMER | TMOD_GATE1__DISABLED;
	// setting Timer one to mode one; aka 16 bits... JP
	TCON_TR0=1;
